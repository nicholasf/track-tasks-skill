---
name: task-tracking
description: Manage work as structured task files in tasks/pending/ and tasks/completed/. Triggers on "create a task", "write a task for", "what tasks are pending", "mark this task complete", "update the task".
depends_on:
  - load-topology-skill
---
